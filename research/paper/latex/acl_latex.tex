...
\hypersetup{
  pdftitle     = {Aion-BibleQA: Evaluating Retrieval and Citation Faithfulness
                  in Verse-Grounded Bible RAG Systems},
  pdfauthor    = {Mohammad Raouf Abedini},
  pdfsubject   = {Natural Language Processing; Retrieval-Augmented Generation;
                  Bible QA; Citation Faithfulness},
  pdfkeywords  = {Bible RAG, citation faithfulness, retrieval evaluation,
                  LLM-as-judge, false-premise robustness, Aion-BibleQA},
  pdfcreator   = {pdfLaTeX},
  colorlinks   = true,
  linkcolor    = black,
  citecolor    = black,
...
\author{Mohammad Raouf Abedini\\
  ...
  Sydney, Australia\\
  \texttt{mohammadraouf.abedini@students.mq.edu.au}\\
