...
For each row, the judge receives: (1) the question, (2) the category, (3) expected behavior from the dataset annotation, (4) the retrieved verse block with full verse texts, and (5) the system answer.
...
We release Aion-BibleQA, the retrieval system, the judge harness, and all benchmark artifacts alongside this paper.
...
We thank the Berean Bible translators for making the BSB publicly available under a generous license, which made this corpus-based study possible.

%% ---------------------------------------------------------------
\section*{Ethics Statement}
%% ---------------------------------------------------------------

This study uses the Berean Standard Bible (BSB), a publicly available translation released under a license permitting research use.
