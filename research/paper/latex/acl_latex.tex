...
To test whether the headline scores survive a change of judge, we re-scored all 40 rows with a cross-family judge (OpenAI \texttt{gpt-4.1}) under the identical rubric and prompt (Table~\ref{tab:multijudge}).
